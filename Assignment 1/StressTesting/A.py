...
total_broadcasted_count = 0  # New variable to track messages broadcasted
...
def broadcast(message, sender_socket=None):
    global message_count, total_message_count, total_broadcasted_count
    ...
    for client_socket in list(clients.keys()):
        ...
        try:
            ...
            # Increment total messages broadcasted
            total_broadcasted_count += 1  # Increment on successful broadcast
...
def run_server():
    ...
    global total_bytes_sent, total_bytes_recv, interval_count, total_message_count, total_broadcasted_count, net_counters
    ...
    while running:
        ...
        if time.time() - last_log_time >= interval:
            ...
            if elapsed_time > 0:
                ...
                print(f"Total messages broadcasted: {total_broadcasted_count}")  # Log broadcasted messages
    ...
    print(f"Total messages broadcasted: {total_broadcasted_count}")  # Log broadcasted messages in final summary
