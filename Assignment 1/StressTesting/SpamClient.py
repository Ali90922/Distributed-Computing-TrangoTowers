...
send_buffer_size = 4096  # You can adjust this to a higher value
recv_buffer_size = 4096  # You can adjust this to a higher value
...
def run_spam_client():
    ...
    while True:
        ...
        counter += 1
        time.sleep(0.30)  # Slowing down the spam rate to avoid overwhelming the server
